...
- Creates Azure Monitor Private Link Scope
...
- [time_sleep.private_endpoint_setup](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/sleep) (resource)
...
### <a name="input_ingestion_access_mode"></a> [ingestion\_access\_mode](#input\_ingestion\_access\_mode)
...
### <a name="input_monitor_private_link_scoped_service"></a> [monitor\_private\_link\_scoped\_service](#input\_monitor\_private\_link\_scoped\_service)
...
### <a name="input_query_access_mode"></a> [query\_access\_mode](#input\_query\_access\_mode)
